...
public abstract class AbstractBLEHeadphoneDeviceSupport extends AbstractBTLESingleDeviceSupport implements HeadphoneHelper.Callback {

    private HeadphoneHelper headphoneHelper;

    public AbstractBLEHeadphoneDeviceSupport(Logger logger) {
        super(logger);
    }
