...
public class LoadFragment extends AbstractChartFragment<LoadFragment.LoadsData> {
    ...
    public String getTitle() {
        return getString(R.string.menuitem_load);
    }
    ...
    protected void updateChartsnUIThread(LoadsData data) {
        ...
        if (supportsTrainingLoad()) {
            ...
            lineDataSets.add(createDataSet(acuteLoadEntries, getString(R.string.acute_load), LOAD_COLOR));
            lineDataSets.add(createDataSet(chronicLoadEntries, getString(R.string.chronic_load), getResources().getColor(R.color.chronic_load)));
            ...
            acuteLoadEntry.label = getString(R.string.acute_load);
            acuteLoadEntry.formColor = LOAD_COLOR;
            legendEntries.add(acuteLoadEntry);
            LegendEntry chronicLoadEntry = new LegendEntry();
            chronicLoadEntry.label = getString(R.string.chronic_load);
            chronicLoadEntry.formColor = getResources().getColor(R.color.chronic_load);
            ...
            int[] colors = new int[]{
                    ContextCompat.getColor(GBApplication.getContext(), R.color.load_low),
                    ContextCompat.getColor(GBApplication.getContext(), R.color.load_optimal),
                    ContextCompat.getColor(GBApplication.getContext(), R.color.load_high),
            };
    ...
    public static int getAcuteColor(Context context) {
        ...
        theme.resolveAttribute(R.attr.acute_load, typedValue, true);
